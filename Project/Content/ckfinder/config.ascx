...
<script runat="server">
    ...
    //Vũ added to get referrer ControllerName
	...
	public override void SetConfig()
	{
        ...
        LicenseName = "Pham Quoc Vu";
        LicenseKey = "R9FMQT5SCDX58TFUAYS18BQXJGXYK759";
        ...
        type = ResourceType.Add("Films");
        //type.Url = BaseUrl + "Films/";
        //type.Dir = BaseDir == "" ? "" : BaseDir + "Films/";
        type.Url = "";
        type.Dir = "C:/Program Files/Adobe/Adobe Media Server 5/webroot/vod";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "avi", "flv", "mp4", "mpc", "mpeg", "mpg", "rm", "rmi", "rmvb", "wmv","f4v" };
        type.DeniedExtensions = new string[] { };
